...
/// </remarks>
public partial class S05_0302Da : Hatobus.ReservationManagementSystem.Common.DataAccessorBase
{
    ...
    /// <returns></returns>
    public DataTable GetEiGyouDataByCondition(Hashtable paramInfoList = null)
    {
        ...
        var crsLedgerBasicEntity = new TCrsLedgerBasicEntity();

        // コース台帳（基本）.コースコード = パラメータ.コースコード
        sqlString.AppendLine(" CLB.CRS_CD = ");
        sqlString.AppendLine(base.setParam(crsLedgerBasicEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), crsLedgerBasicEntity.CrsCd.DBType, crsLedgerBasicEntity.CrsCd.IntegerBu));

        // コース台帳（基本）.出発日 = パラメータ.出発日
        sqlString.AppendLine(" AND CLB.SYUPT_DAY = ");
        sqlString.AppendLine(base.setParam(crsLedgerBasicEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), crsLedgerBasicEntity.SyuptDay.DBType, crsLedgerBasicEntity.SyuptDay.IntegerBu));

        // コース台帳（基本）.号車 = パラメータ.号車
        sqlString.AppendLine(" AND CLB.GOUSYA = ");
        sqlString.AppendLine(base.setParam(crsLedgerBasicEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), crsLedgerBasicEntity.Gousya.DBType, crsLedgerBasicEntity.Gousya.IntegerBu));
        try
        {
    ...
    /// <param name="paramInfoList">検索条件</param>
    /// <returns></returns>
    public DataTable GetCostKakuteiGenkinUtiwakeByCondition(Hashtable paramInfoList = null)
    {
    ...
    /// <returns></returns>
    public DataTable GetCostKakuteiGenkinUtiwakeKoshakashoByCondition(Hashtable paramInfoList = null, string kbn = null)
    {
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public DataTable GetCostKakuteiSokyakFee(Hashtable paramInfoList = null)
    {

        // 戻り値
        DataTable returnValue = default;
        var sqlString = new StringBuilder();
        var costKakuteiSokyakFeeEntity = new TCostKakuteiSokyakFeeEntity();
        ...
        sqlString.AppendLine(base.setParam(costKakuteiSokyakFeeEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), costKakuteiSokyakFeeEntity.CrsCd.DBType, costKakuteiSokyakFeeEntity.CrsCd.IntegerBu));
        // 原価確定送客手数料.出発日 = パラメータ.出発日
        sqlString.AppendLine(" AND CKSF.SYUPT_DAY =  ");
        sqlString.AppendLine(base.setParam(costKakuteiSokyakFeeEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), costKakuteiSokyakFeeEntity.SyuptDay.DBType, costKakuteiSokyakFeeEntity.SyuptDay.IntegerBu));
        // 原価確定送客手数料.号車 = パラメータ.号車
        sqlString.AppendLine(" AND CKSF.GOUSYA =   ");
        sqlString.AppendLine(base.setParam(costKakuteiSokyakFeeEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), costKakuteiSokyakFeeEntity.Gousya.DBType, costKakuteiSokyakFeeEntity.Gousya.IntegerBu));
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public DataTable GetCrsLedgerCostKoshakasho(Hashtable paramInfoList = null)
    {

        // 戻り値
        DataTable returnValue = default;
        var sqlString = new StringBuilder();
        var crsLedgerCostKoshakashoEntity = new TCrsLedgerCostKoshakashoEntity();
        ...
        sqlString.AppendLine(" YIB.CRS_CD =  ");
        sqlString.AppendLine(base.setParam(crsLedgerCostKoshakashoEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), crsLedgerCostKoshakashoEntity.CrsCd.DBType, crsLedgerCostKoshakashoEntity.CrsCd.IntegerBu));
        // 予約情報（基本）.出発日 = パラメータ.出発日
        sqlString.AppendLine(" AND YIB.SYUPT_DAY =  ");
        sqlString.AppendLine(base.setParam(crsLedgerCostKoshakashoEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), crsLedgerCostKoshakashoEntity.SyuptDay.DBType, crsLedgerCostKoshakashoEntity.SyuptDay.IntegerBu));
        // 予約情報（基本）.号車 = パラメータ.号車
        sqlString.AppendLine(" AND YIB.GOUSYA =   ");
        sqlString.AppendLine(base.setParam(crsLedgerCostKoshakashoEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), crsLedgerCostKoshakashoEntity.Gousya.DBType, crsLedgerCostKoshakashoEntity.Gousya.IntegerBu));
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public DataTable GetCostKakuteiChosho(Hashtable paramInfoList = null)
    {

        // 戻り値
        DataTable returnValue = default;
        var sqlString = new StringBuilder();
        var costKakuteiChoshoEntity = new TCostKakuteiChoshoEntity();
        ...
        sqlString.AppendLine(base.setParam(costKakuteiChoshoEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), costKakuteiChoshoEntity.CrsCd.DBType, costKakuteiChoshoEntity.CrsCd.IntegerBu));
        // 原価確定徴証.出発日 = パラメータ.出発日
        sqlString.AppendLine(" AND CKC.SYUPT_DAY =  ");
        sqlString.AppendLine(base.setParam(costKakuteiChoshoEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), costKakuteiChoshoEntity.SyuptDay.DBType, costKakuteiChoshoEntity.SyuptDay.IntegerBu));
        // 原価確定徴証.号車 = パラメータ.号車
        sqlString.AppendLine(" AND CKC.GOUSYA =   ");
        sqlString.AppendLine(base.setParam(costKakuteiChoshoEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), costKakuteiChoshoEntity.Gousya.DBType, costKakuteiChoshoEntity.Gousya.IntegerBu));
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public DataTable GetCostKakuteiChoshoChargeInfo(Hashtable paramInfoList = null)
    {

        // 戻り値
        DataTable returnValue = default;
        var sqlString = new StringBuilder();
        var costKakuteiChoshoChargeInfoEntity = new TCostKakuteiChoshoChargeInfoEntity();
        ...
        sqlString.AppendLine(base.setParam(costKakuteiChoshoChargeInfoEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), costKakuteiChoshoChargeInfoEntity.CrsCd.DBType, costKakuteiChoshoChargeInfoEntity.CrsCd.IntegerBu));
        // 原価確定徴証(料金情報).出発日 = パラメータ.出発日
        sqlString.AppendLine(" AND CKCCI.SYUPT_DAY =  ");
        sqlString.AppendLine(base.setParam(costKakuteiChoshoChargeInfoEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), costKakuteiChoshoChargeInfoEntity.SyuptDay.DBType, costKakuteiChoshoChargeInfoEntity.SyuptDay.IntegerBu));
        // 原価確定徴証(料金情報).号車 = パラメータ.号車
        sqlString.AppendLine(" AND CKCCI.GOUSYA =   ");
        sqlString.AppendLine(base.setParam(costKakuteiChoshoChargeInfoEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), costKakuteiChoshoChargeInfoEntity.Gousya.DBType, costKakuteiChoshoChargeInfoEntity.Gousya.IntegerBu));
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public DataTable GetCrsLedgerCostKoshakashoClckck(Hashtable paramInfoList = null, string kbn = null)
    {
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public DataTable GetGenbaraiWithdrawalHistory(Hashtable paramInfoList = null)
    {

        // 戻り値
        DataTable returnValue = default;
        var sqlString = new StringBuilder();
        var genbaraiWithdrawalHistoryEntity = new TGenbaraiWithdrawalHistoryEntity();
        ...
        sqlString.AppendLine(base.setParam(genbaraiWithdrawalHistoryEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), genbaraiWithdrawalHistoryEntity.CrsCd.DBType, genbaraiWithdrawalHistoryEntity.CrsCd.IntegerBu));
        sqlString.AppendLine(" AND GWH.SYUPT_DAY =  ");
        sqlString.AppendLine(base.setParam(genbaraiWithdrawalHistoryEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), genbaraiWithdrawalHistoryEntity.SyuptDay.DBType, genbaraiWithdrawalHistoryEntity.SyuptDay.IntegerBu));
        sqlString.AppendLine(" AND GWH.GOUSYA =   ");
        sqlString.AppendLine(base.setParam(genbaraiWithdrawalHistoryEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), genbaraiWithdrawalHistoryEntity.Gousya.DBType, genbaraiWithdrawalHistoryEntity.Gousya.IntegerBu));
        sqlString.AppendLine(" UNION ALL  ");
        sqlString.AppendLine(" SELECT  ");
        // 出金日
...
internal partial class SurroundingClass
{
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public DataTable GetAddBtnKoshakashoChoshoByCondition(Hashtable paramInfoList = null)
    {
    ...
    /// <returns></returns>
    public DataTable GetSyohizei(string riyouDay)
    {
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public DataTable GetCodeMasterData(string codeBunrui)
    {
    ...
    /// <returns></returns>
    public int DeleteCostKakuteiGenkinUtiwake(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var costKakuteiGenkinUtiwakeEntity = new TCostKakuteiGenkinUtiwakeEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
        ...
        sqlString.AppendLine(base.setParam(costKakuteiGenkinUtiwakeEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), costKakuteiGenkinUtiwakeEntity.CrsCd.DBType, costKakuteiGenkinUtiwakeEntity.CrsCd.IntegerBu));

        // 出発日=画面間パラメータ.出発日
        sqlString.AppendLine(" AND SYUPT_DAY =  ");
        sqlString.AppendLine(base.setParam(costKakuteiGenkinUtiwakeEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), costKakuteiGenkinUtiwakeEntity.SyuptDay.DBType, costKakuteiGenkinUtiwakeEntity.SyuptDay.IntegerBu));

        // 号車=画面間パラメータ.号車」
        sqlString.AppendLine(" AND GOUSYA =  ");
        sqlString.AppendLine(base.setParam(costKakuteiGenkinUtiwakeEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), costKakuteiGenkinUtiwakeEntity.Gousya.DBType, costKakuteiGenkinUtiwakeEntity.Gousya.IntegerBu));
    ...
    /// <param name="tran"></param>
    /// <returns></returns>
    public int DeleteCostKakuteiSokyakFee(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var costKakuteiSokyakFeeEntity = new TCostKakuteiSokyakFeeEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
    ...
    /// <param name="tran"></param>
    /// <returns></returns>
    public int DeleteCostKakuteiChosho(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var costKakuteiChoshoEntity = new TCostKakuteiChoshoEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
    ...
    /// <param name="tran"></param>
    /// <returns></returns>
    public int DeleteCostKakuteiChoshoChargeInfo(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var costKakuteiChoshoChargeInfoEntity = new TCostKakuteiChoshoChargeInfoEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
    ...
    /// <param name="tran"></param>
    /// <returns></returns>
    public int DeleteGenbaraiWithdrawalHistory(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var genbaraiWithdrawalHistoryEntity = new TGenbaraiWithdrawalHistoryEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
    ...
    /// <returns></returns>
    public int UpdGenbaraiEntry(Hashtable paramInfoList = null, OracleTransaction tran = default, string kbn = null, string btnKbn = null)
    {
        var genbaraiEntryEntity = new TGenbaraiEntryEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
        sqlString.AppendLine(" UPDATE T_GENBARAI_ENTRY SET ");

        // 出金営業所コード
        sqlString.AppendLine(default
...
/* Cannot convert BinaryExpressionSyntax, System.NullReferenceException: Object reference not set to an instance of an object.
   at ICSharpCode.CodeConverter.Util.FromRoslyn.ITypeSymbolExtensions.IsEnumType(ITypeSymbol type) in D:\a\CodeConverter\CodeConverter\CodeConverter\Util\FromRoslyn\ITypeSymbolExtensions.cs:line 552
   at ICSharpCode.CodeConverter.CSharp.ExpressionNodeVisitor.VisitBinaryExpression(BinaryExpressionSyntax node) in D:\a\CodeConverter\CodeConverter\CodeConverter\CSharp\ExpressionNodeVisitor.cs:line 769
...
Input:
" WITHDRAWAL_EIGYOSYO_CD = '" & paramInfoList.Item(.WithdrawalEigyosyoCd.PhysicsName).ToString 
 */
+ "'");
        // 帰着予定営業所コード
        sqlString.AppendLine(default
...
Input:
" ,RETURN_YOTEI_EIGYOSYO_CD = '" & paramInfoList.Item(.ReturnYoteiEigyosyoCd.PhysicsName).ToString 
 */
+ "'");
        // 添乗員名
        sqlString.AppendLine(default
...
Input:
" ,TENJYOIN_NAME = '" & paramInfoList.Item(.TenjyoinName.PhysicsName).ToString 
 */
+ "'");

        // 業務管理課の場合は「確認日」、「確定者コード」、「確定営業所コード」は更新しない
        if (kbn.Equals("E") == false)
        {
            // 「F10：確定」ボタン場合
            if (btnKbn.Equals("K"))
            {
...
Input:
" ,KAKUTEI_DAY = " & paramInfoList.Item(.KakuteiDay.PhysicsName).ToString 
 */
+ "");
                // 確定者コード
                sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
       ...
       Input:
       " ,KAKUTEI_PERSON_CD = '" & paramInfoList.Item(.KakuteiPersonCd.PhysicsName).ToString 
        */
       + "'");
                // 確定営業所コード
                sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
      ...
      Input:
      " ,KAKUTEI_EIGYOSYO_CD = '" & paramInfoList.Item(.KakuteiEigyosyoCd.PhysicsName).ToString 
       */
      + "'");
            }
            else
        ...
        // コースコード=画面間パラメータ.コースコード 
        sqlString.AppendLine(" CRS_CD =  ");
        sqlString.AppendLine(base.setParam(genbaraiEntryEntity.CrsCd.PhysicsName, paramInfoList["CRS_CD"].ToString(), genbaraiEntryEntity.CrsCd.DBType, genbaraiEntryEntity.CrsCd.IntegerBu));

        // 出発日=画面間パラメータ.出発日
        sqlString.AppendLine(" AND SYUPT_DAY =  ");
        sqlString.AppendLine(base.setParam(genbaraiEntryEntity.SyuptDay.PhysicsName, paramInfoList["SYUPT_DAY"].ToString(), genbaraiEntryEntity.SyuptDay.DBType, genbaraiEntryEntity.SyuptDay.IntegerBu));

        // 号車=画面間パラメータ.号車」
        sqlString.AppendLine(" AND GOUSYA =  ");
        sqlString.AppendLine(base.setParam(genbaraiEntryEntity.Gousya.PhysicsName, paramInfoList["GOUSYA"].ToString(), genbaraiEntryEntity.Gousya.DBType, genbaraiEntryEntity.Gousya.IntegerBu));
        return execNonQuery(tran, sqlString.ToString());
    }
    ...
    /// <param name="btnKbn"></param>
    /// <returns></returns>
    public int InsertGenbaraiEntry(Hashtable paramInfoList = null, OracleTransaction tran = default, string kbn = null, string btnKbn = null)
    {
        var genbaraiEntryEntity = new TGenbaraiEntryEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
...
Input:
"    '" & paramInfoList.Item(.CrsCd.PhysicsName).ToString 
 */
+ "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    , " & paramInfoList.Item(.SyuptDay.PhysicsName).ToString 
   */
  + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Gousya.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ,'" & paramInfoList.Item(.WithdrawalEigyosyoCd.PhysicsName).ToString 
    */
   + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ,'" & paramInfoList.Item(.ReturnYoteiEigyosyoCd.PhysicsName).ToString 
   */
  + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ,'" & paramInfoList.Item(.TenjyoinName.PhysicsName).ToString 
   */
  + "'");
...
Input:
" ," & paramInfoList.Item(.KakuteiDay.PhysicsName).ToString 
 */
+ "");
                // 確定者コード
                sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
       ...
       Input:
       " ,'" & paramInfoList.Item(.KakuteiPersonCd.PhysicsName).ToString 
        */
       + "'");
                // 確定営業所コード
                sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
      ...
      Input:
      " ,'" & paramInfoList.Item(.KakuteiEigyosyoCd.PhysicsName).ToString 
       */
      + "'");
            }
            else
    ...
    /// <returns></returns>
    public int InsertCostKakuteiGenkinUtiwake(Hashtable paramInfoList = null, OracleTransaction tran = default, int kbn = default)
    {
        var costKakuteiGenkinUtiwakeEntity = new TCostKakuteiGenkinUtiwakeEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
...
Input:
"    , " & paramInfoList.Item(.Seq.PhysicsName).ToString 
 */
+ "");
        }
        else
...
Input:
"    ,'" & paramInfoList.Item(.CostSiharaiUtiwakeCd.PhysicsName).ToString 
 */
+ "'");
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
      ...
      Input:
      "    ,'" & paramInfoList.Item(.CostSiharaiUtiwakeName.PhysicsName).ToString 
       */
      + "'");
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
      ...
      Input:
      "    ,'" & paramInfoList.Item(.Memo.PhysicsName).ToString 
       */
      + "'");
        }
        else
...
Input:
"    ,'" & paramInfoList.Item(.NewKbn.PhysicsName).ToString 
 */
+ "'");
        }
        else
...
Input:
"    ," & paramInfoList.Item(.RiyouNum.PhysicsName).ToString 
 */
+ "");
        }
        else
...
Input:
"    ,'" & paramInfoList.Item(.SeasonCd.PhysicsName).ToString 
 */
+ "'");
        if (kbn == 1)
        {
...
Input:
"    ," & paramInfoList.Item(.ShishutsuKingaku.PhysicsName).ToString 
 */
+ "");
        }
        else
...
Input:
"    ," & paramInfoList.Item(.ShunyuKingaku.PhysicsName).ToString 
 */
+ "");
        if (kbn == 1)
        {
...
Input:
"    ,'" & paramInfoList.Item(.SiharaiHoho.PhysicsName).ToString 
 */
+ "'");
        }
        else
...
Input:
"    ,'" & paramInfoList.Item(.SiireSakiCd.PhysicsName).ToString 
 */
+ "'");
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
      ...
      Input:
      "    ,'" & paramInfoList.Item(.SiireSakiEdaban.PhysicsName).ToString 
       */
      + "'");
        }
        else
...
Input:
"    ,'" & paramInfoList.Item(.SiwakeKbn.PhysicsName).ToString 
 */
+ "'");
        }
        else if (kbn == 2)
...
Input:
"    ,'" & paramInfoList.Item(.TankaKbn.PhysicsName).ToString 
 */
+ "'");
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
      ...
      Input:
      "    ,'" & paramInfoList.Item(.TaxKbn.PhysicsName).ToString 
       */
      + "'");
        }
        else
...
Input:
"    ," & paramInfoList.Item(.Year.PhysicsName).ToString 
 */
+ "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Ym.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.RiyouDay.PhysicsName).ToString 
    */
   + "");
        if (kbn == 1)
        {
...
Input:
"    ,'" & paramInfoList.Item(.SeisanMokutekiCd.PhysicsName).ToString 
 */
+ "'");
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
      ...
      Input:
      "    ," & paramInfoList.Item(.BathTax.PhysicsName).ToString 
       */
      + "");
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
       ...
       Input:
       "    ," & paramInfoList.Item(.Per.PhysicsName).ToString 
        */
       + "");
        }
        else
...
Input:
"    ," & paramInfoList.Item(.LineNo.PhysicsName).ToString 
 */
+ "");
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
       ...
       Input:
       "    ," & paramInfoList.Item(.GroupNo.PhysicsName).ToString 
        */
       + "");
        }
        else
    ...
    /// <param name="tran"></param>
    /// <returns></returns>
    public int InsertCostKakuteiSokyakFee(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var costKakuteiSokyakFeeEntity = new TCostKakuteiSokyakFeeEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
...
+ "'");
        ...
        if (!string.IsNullOrEmpty(paramInfoList(costKakuteiSokyakFeeEntity.Daisu.PhysicsName).ToString))
        {
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
/* Cannot convert BinaryExpressionSyntax, System.NullReferenceException: Object reference not set to an instance of an object.
...
Input:
"    ," & paramInfoList.Item(.Daisu.PhysicsName).ToString 
 */
+ "");
        }
        else
...
Input:
"    ," & paramInfoList.Item(.DenpyouNo.PhysicsName).ToString 
 */
+ "");
        sqlString.AppendLine("    ,TO_NUMBER(TO_CHAR(SYSDATE,'yyyyMMdd'))");
        sqlString.AppendLine("    ,'" + UserInfoManagement.userId + "'");
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ,'" & paramInfoList.Item(.HiSeikyuSakiCd.PhysicsName).ToString 
    */
   + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ,'" & paramInfoList.Item(.HiSeikyuSakiEdaban.PhysicsName).ToString 
   */
  + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ,'" & paramInfoList.Item(.HiSeikyuSakiSeisanMokuteki.PhysicsName).ToString 
   */
  + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ," & paramInfoList.Item(.KakuninGaku.PhysicsName).ToString 
   */
  + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   + "'");
        ...
        if (!string.IsNullOrEmpty(paramInfoList(costKakuteiSokyakFeeEntity.Ninzu.PhysicsName).ToString))
        {
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
/* Cannot convert BinaryExpressionSyntax, System.NullReferenceException: Object reference not set to an instance of an object.
...
Input:
"    ," & paramInfoList.Item(.Ninzu.PhysicsName).ToString 
 */
+ "");
        }
        else
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ,'" & paramInfoList.Item(.SiireSakiKindCd.PhysicsName).ToString 
   */
  + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ,'" & paramInfoList.Item(.SokyakFeeCalcHohoKbn.PhysicsName).ToString 
   */
  + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ,'" & paramInfoList.Item(.SokyakFeeGenkinPaymentKbn.PhysicsName).ToString 
   */
  + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  + "");
        ...
        if (!string.IsNullOrEmpty(paramInfoList(costKakuteiSokyakFeeEntity.Tanka.PhysicsName).ToString))
        {
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
/* Cannot convert BinaryExpressionSyntax, System.NullReferenceException: Object reference not set to an instance of an object.
...
Input:
"    ," & paramInfoList.Item(.Tanka.PhysicsName).ToString 
 */
+ "");
        }
        else
        ...
        if (!string.IsNullOrEmpty(paramInfoList(costKakuteiSokyakFeeEntity.Uriage.PhysicsName).ToString))
        {
            sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
/* Cannot convert BinaryExpressionSyntax, System.NullReferenceException: Object reference not set to an instance of an object.
...
Input:
"    ," & paramInfoList.Item(.Uriage.PhysicsName).ToString 
 */
+ "");
        }
        else
...
+ "");
    ...
    /// <param name="tran"></param>
    /// <returns></returns>
    public int InsertCostKakuteiChosho(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var costKakuteiChoshoEntity = new TCostKakuteiChoshoEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ,'" & paramInfoList.Item(.ChoshoKbn.PhysicsName).ToString 
    */
   + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    , " & paramInfoList.Item(.Com.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    , " & paramInfoList.Item(.ComGaku.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    , " & paramInfoList.Item(.Net.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    , " & paramInfoList.Item(.RiyouYmd.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ,'" & paramInfoList.Item(.SeisanHoho.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ,'" & paramInfoList.Item(.SiireSakiShikibetsuCd.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    , " & paramInfoList.Item(.SyohiTax.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   + "");
        ...
        if (!string.IsNullOrEmpty(paramInfoList(costKakuteiChoshoEntity.KoshakashoUnkyuuKbn.PhysicsName).ToString))
        {
...
internal partial class SurroundingClass
{
    ...
    /// <param name="tran"></param>
    /// <returns></returns>
    public int InsertCostKakuteiChoshoChargeInfo(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var costKakuteiChoshoChargeInfoEntity = new TCostKakuteiChoshoChargeInfoEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ,'" & paramInfoList.Item(.ChargeKbnJininCd.PhysicsName).ToString 
    */
   + "'");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
  ...
  Input:
  "    ," & paramInfoList.Item(.BathTaxTanka.PhysicsName).ToString 
   */
  + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Charge1.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Charge2.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Charge3.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Charge4.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Charge5.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Ninzu1.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Ninzu2.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Ninzu3.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Ninzu4.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.Ninzu5.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine("    ,NULL");
        sqlString.AppendLine("    ,TO_NUMBER(TO_CHAR(SYSDATE,'yyyyMMdd'))");
    ...
    /// <param name="paramInfoList"></param>
    /// <returns></returns>
    public int InsertGenbaraiWithdrawalHistory(Hashtable paramInfoList = null, OracleTransaction tran = default)
    {
        var genbaraiWithdrawalHistoryEntity = new TGenbaraiWithdrawalHistoryEntity();
        int returnValue = 0;
        var sqlString = new StringBuilder();
...
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.WithdrawalDay.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine(default
#error Cannot convert BinaryExpressionSyntax - see comment for details
   ...
   Input:
   "    ," & paramInfoList.Item(.WithdrawalGaku.PhysicsName).ToString 
    */
   + "");
        sqlString.AppendLine("    ,NULL");
        sqlString.AppendLine("    ,TO_NUMBER(TO_CHAR(SYSDATE,'yyyyMMdd'))");
