...
/// </summary>
public partial class Room_DA : DataAccessorBase
{
    ...
    /// <returns></returns>
    public DataTable accessRoomTehai(accessType type, Hashtable paramInfoList = null)
    {
        // SQL文字列
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    protected string getRoom(Hashtable paramList)
    {
        ...
        sqlString.AppendLine(" WHERE BASIC.SYUPT_DAY = " + setParam("SYUPT_DAY", paramList["SYUPT_DAY"], OracleDbType.Decimal, 8, 0));
        sqlString.AppendLine(" AND BASIC.CRS_CD = " + setParam("CRS_CD", paramList["CRS_CD"], OracleDbType.Char));
        if (!string.IsNullOrEmpty(Conversions.ToString(paramList["GOUSYA"])))
        {
            sqlString.AppendLine(" AND BASIC.GOUSYA = " + setParam("GOUSYA", paramList["GOUSYA"], OracleDbType.Decimal, 3, 0));
        }
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public int executeRoomTehai(accessType type, Hashtable paramInfoList)
    {
    ...
    private string executeUpdateBasicData(Hashtable paramList)
    {
        ...
        sqlString.AppendLine(" ROOM_ZANSU_SOKEI = " + setParam("ROOM_ZANSU_SOKEI", paramList["ROOM_ZANSU_SOKEI"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",ROOM_ZANSU_ONE_ROOM = " + setParam("ROOM_ZANSU_ONE_ROOM", paramList["ROOM_ZANSU_ONE_ROOM"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",ROOM_ZANSU_TWO_ROOM = " + setParam("ROOM_ZANSU_TWO_ROOM", paramList["ROOM_ZANSU_TWO_ROOM"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",ROOM_ZANSU_THREE_ROOM = " + setParam("ROOM_ZANSU_THREE_ROOM", paramList["ROOM_ZANSU_THREE_ROOM"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",ROOM_ZANSU_FOUR_ROOM = " + setParam("ROOM_ZANSU_FOUR_ROOM", paramList["ROOM_ZANSU_FOUR_ROOM"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",ROOM_ZANSU_FIVE_ROOM = " + setParam("ROOM_ZANSU_FIVE_ROOM", paramList["ROOM_ZANSU_FIVE_ROOM"], OracleDbType.Decimal, 3, 0));
        if (Conversions.ToInteger(paramList["CRS_BLOCK_CAPACITY"]) != 0)
        {
            sqlString.AppendLine(",JYOSYA_CAPACITY = " + setParam("JYOSYA_CAPACITY", paramList["JYOSYA_CAPACITY"], OracleDbType.Decimal, 3, 0));
            sqlString.AppendLine(",YOYAKU_KANOU_NUM = " + setParam("YOYAKU_KANOU_NUM", paramList["YOYAKU_KANOU_NUM"], OracleDbType.Decimal, 3, 0));
            sqlString.AppendLine(",KUSEKI_NUM_TEISEKI = " + setParam("KUSEKI_NUM_TEISEKI", paramList["KUSEKI_NUM_TEISEKI"], OracleDbType.Decimal, 3, 0));
        }

        sqlString.AppendLine(",ONE_SANKA_FLG = " + setParam("ONE_SANKA_FLG", paramList["ONE_SANKA_FLG"], OracleDbType.Char));
        sqlString.AppendLine(",AIBEYA_USE_FLG = " + setParam("AIBEYA_USE_FLG", paramList["AIBEYA_USE_FLG"], OracleDbType.Char));
        sqlString.AppendLine(",TEIINSEI_FLG = " + setParam("TEIINSEI_FLG", paramList["TEIINSEI_FLG"], OracleDbType.Char));
        sqlString.AppendLine(",CRS_BLOCK_CAPACITY = " + setParam("CRS_BLOCK_CAPACITY", paramList["CRS_BLOCK_CAPACITY"], OracleDbType.Decimal, 5, 0));
        sqlString.AppendLine(",CRS_BLOCK_ROOM_NUM = " + setParam("CRS_BLOCK_ROOM_NUM", paramList["CRS_BLOCK_ROOM_NUM"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",CRS_BLOCK_ONE_1R = " + setParam("CRS_BLOCK_ONE_1R", paramList["CRS_BLOCK_ONE_1R"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",CRS_BLOCK_TWO_1R = " + setParam("CRS_BLOCK_TWO_1R", paramList["CRS_BLOCK_TWO_1R"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",CRS_BLOCK_THREE_1R = " + setParam("CRS_BLOCK_THREE_1R", paramList["CRS_BLOCK_THREE_1R"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",CRS_BLOCK_FOUR_1R = " + setParam("CRS_BLOCK_FOUR_1R", paramList["CRS_BLOCK_FOUR_1R"], OracleDbType.Decimal, 3, 0));
        sqlString.AppendLine(",CRS_BLOCK_FIVE_1R = " + setParam("CRS_BLOCK_FIVE_1R", paramList["CRS_BLOCK_FIVE_1R"], OracleDbType.Decimal, 3, 0));
        ...
        sqlString.AppendLine(" AND ");
        sqlString.AppendLine(" GOUSYA = " + setParam("GOUSYA", paramList["GOUSYA"], OracleDbType.Decimal, 3, 0));
        return sqlString.ToString();
    }
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    private string executeUpdateAddInfoData(Hashtable paramList)
    {
        var sqlString = new StringBuilder();
        paramClear();
        ...
        sqlString.AppendLine(" SET ");
        sqlString.AppendLine(" UKETOME_KBN_ONE_1R = " + setParam("UKETOME_KBN_ONE_1R", paramList["UKETOME_KBN_ONE_1R"], OracleDbType.Char));
        sqlString.AppendLine(",UKETOME_KBN_TWO_1R = " + setParam("UKETOME_KBN_TWO_1R", paramList["UKETOME_KBN_TWO_1R"], OracleDbType.Char));
        sqlString.AppendLine(",UKETOME_KBN_THREE_1R = " + setParam("UKETOME_KBN_THREE_1R", paramList["UKETOME_KBN_THREE_1R"], OracleDbType.Char));
        sqlString.AppendLine(",UKETOME_KBN_FOUR_1R = " + setParam("UKETOME_KBN_FOUR_1R", paramList["UKETOME_KBN_FOUR_1R"], OracleDbType.Char));
        sqlString.AppendLine(",UKETOME_KBN_FIVE_1R = " + setParam("UKETOME_KBN_FIVE_1R", paramList["UKETOME_KBN_FIVE_1R"], OracleDbType.Char));
        sqlString.AppendLine(",SYSTEM_UPDATE_DAY = " + setParam("SYSTEM_UPDATE_DAY", CommonDateUtil.getSystemTime, OracleDbType.Date));
        sqlString.AppendLine(",SYSTEM_UPDATE_PGMID = " + setParam("SYSTEM_UPDATE_PGMID", paramList["SYSTEM_UPDATE_PGMID"], OracleDbType.Char));
        sqlString.AppendLine(",SYSTEM_UPDATE_PERSON_CD = " + setParam("SYSTEM_UPDATE_PERSON_CD", paramList["SYSTEM_UPDATE_PERSON_CD"], OracleDbType.Varchar2));
        // WHERE句
