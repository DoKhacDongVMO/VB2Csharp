...
''' </summary>
Public Class SaikouKahiGousya_DA
...
#Region " SELECT処理 "
    ...
    ''' <returns></returns>
    Public Function accessSaikouKahiGousya(ByVal paramInfoList As Hashtable) As DataTable
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Protected Overloads Function getSaikouKahiGousya(ByVal paramList As Hashtable) As String
        ...
        sqlString.AppendLine(" INFOBASIC.SYUPT_DAY = " & setParam("SYUPT_DAY", paramList.Item("SYUPT_DAY"), OracleDbType.Decimal, 8, 0))
        sqlString.AppendLine(" AND ")
        sqlString.AppendLine(" INFOBASIC.CRS_CD = " & setParam("CRS_CD", paramList.Item("CRS_CD"), OracleDbType.Char))
        sqlString.AppendLine(" AND ")
        ...
        sqlString.AppendLine(" WHERE ")
        sqlString.AppendLine(" INFOBASIC2.SYUPT_DAY = " & setParam("SYUPT_DAY", paramList.Item("SYUPT_DAY"), OracleDbType.Decimal, 8, 0))
        sqlString.AppendLine(" AND ")
        sqlString.AppendLine(" INFOBASIC2.CRS_CD = " & setParam("CRS_CD", paramList.Item("CRS_CD"), OracleDbType.Char))
        sqlString.AppendLine(" AND ")
        ...
        sqlString.AppendLine(" AND ")
        sqlString.AppendLine(" BASIC.HOUJIN_GAIKYAKU_KBN = " & setParam("HOUJIN_GAIKYAKU_KBN", paramList.Item("HOUJIN_GAIKYAKU_KBN"), OracleDbType.Char))
        sqlString.AppendLine(" AND ")
