...
''' <remarks></remarks>
<Serializable()> _
Public Class TCrsLedgerCrsInfoEntity  ' コース台帳（コース情報）エンティティ


Private _crsCd As New EntityKoumoku_MojiType	' コースコード
Private _crsJoken As New EntityKoumoku_MojiType	' コース条件
...
''' <returns></returns>
''' <remarks></remarks>
Public Property crsJoken() As EntityKoumoku_MojiType
Get
    Return _crsJoken
End Get
Set(ByVal value As EntityKoumoku_MojiType)
